    ...
    <div class="sg4wp">
        ...
        <form action="options.php" method="post" class="sgMain">
            ...
            <table>
                <tr class="sg4wp">
                    <th>Steam 64 位 ID:</th>
                    <td><input type="text" name="zm_sg4wp_id" style="width: 300px" value="<?php echo esc_attr(get_option('zm_sg4wp_id')); ?>"></td>
                </tr>
                <tr class="sg4wp">
                    <th>顶栏卡片样式:</th>
                    <td><select name="zm_sg4wp_cardtype">
                        <option value="1" <?php echo esc_attr(get_option('zm_sg4wp_cardtype')) == "1" ?  'selected = "selected"' : "" ?> >类型1</option>
                        <option value="2" <?php echo esc_attr(get_option('zm_sg4wp_cardtype')) == "2" ?  'selected = "selected"' : "" ?>>类型2</option>
                        <option value="3" <?php echo esc_attr(get_option('zm_sg4wp_cardtype')) == "3" ?  'selected = "selected"' : "" ?>>类型3</option>
                    </select>
